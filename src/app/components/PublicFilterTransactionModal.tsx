...
const PublicFilterTransactionModal = ({
  isOpen,
  setIsOpen,
  setPage,
  partyType,
                ...
                <form onSubmit={handleSubmit} className="space-y-4 mt-6">
                  <div className="flex flex-col space-y-1">
                    ...
                    >
                      ...
                      <option value="credit">{`${
                        partyType == "customer"
                          ? transactionType.customer["Dukandaar Ko Payment Ki"]
                          : transactionType.supplier["Dukandaar Ko Maal Becha"]
                      }`}</option>
                      <option value="debit">
                        {" "}
                        {`${
...
export default PublicFilterTransactionModal;
